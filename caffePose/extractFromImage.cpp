...
// Producer
DEFINE_string(image_path,               "imagenet/COCO_val2014_000000000192.jpg",     "Process the desired image.");
// OpenPose
...
DEFINE_string(net_resolution,           "-1x80",       "Multiples of 16. If it is increased, the accuracy potentially increases. If it is"
...
int openPoseTutorialPose1()
{
    try
    {
        ...
        cout << netInputSize << outputSize << FLAGS_scale_number <<"---"<< FLAGS_scale_gap << endl;
        ...
        cout <<  "--" << FLAGS_model_folder << FLAGS_num_gpu_start << endl;
        op::PoseCpuRenderer poseRenderer{poseModel, (float)FLAGS_render_threshold, !FLAGS_disable_blending,
                                         (float)FLAGS_alpha_pose};
        cout << FLAGS_render_threshold << ";" << FLAGS_disable_blending << ";" << FLAGS_alpha_pose << endl;
        ...
        for (int i=0;i<scaleInputToNetInputs.size();++i)
        {
            cout << scaleInputToNetInputs[i] << endl;
        }
        printf("\n");
