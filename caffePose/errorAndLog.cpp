...
namespace op
{
                                  ...
                                  const std::string& file = "")
    {
        ...
        if (hasLocation)
            fullMessage += file + ":" + function + "():" + to_string(line);
    ...
    std::string getTime()
    {
        ...
        return to_string(timeStruct.tm_year) + '_' + to_string(timeStruct.tm_mon)
               + '_' + to_string(timeStruct.tm_mday) + "___" + to_string(timeStruct.tm_hour)
               + '_' + to_string(timeStruct.tm_min) + '_' + to_string(timeStruct.tm_sec);
    }
